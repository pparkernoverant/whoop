...
User.create(email: 'test_user_1@test.com', username: 'test_user_1', password: 'password')
User.create(email: 'test_user_2@test.com', username: 'test_user_2', password: 'password')
